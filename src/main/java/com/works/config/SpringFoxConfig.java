...
public class SpringFoxConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "Bilge Adam - Json Bulut Rest Api",
                "Örnek kullanıcı: ROLE_REST -> rest@mail.com, 1 => ROLE_MVC -> umut@mail.com, 12",
                "API 1.0",
                "Terms of service",
                new Contact("Json Bulut", "www.example.com", "tuy@company.com"),
